...
var mtCookieDomain = ".nishifuna-seitai.jp";
var mtCookiePath = "/";
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'c9d840fe87b6a4c9c781ef59922841589c7daf86';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=http%3A%2F%2Fwww.nishifuna-seitai.jp%2Fblog%2F';
        }
    } else {
