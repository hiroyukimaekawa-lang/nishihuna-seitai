...
<title>船橋のエステなら『パラ』</title>
<meta name="keywords" content="エステ,西船橋,船橋市,パラ,痩身,脚やせ,Pa.Ra,美脚" />
<meta name="description" content="本気で痩せたい方は船橋市西船橋駅近の『トータルボディケア・パラ』にお任せください！多数の痩身マシンを駆使し、脂肪燃焼・体質改善を行い、リバウンドの無いスリムな身体へ導きます。" />
...
<a href="index.php">
	...
	<img src="img/topSideImage.png" width="243" height="350" align="right" />
	<div id="information">
...
<img src="img/about02.png" alt="PaRaの手技によるマッサージ" width="675" height="160" /><br /><br />
<img src="img/about03.png" alt="雑誌に取り上げられました" width="675" />		
		</div><!--余白-->
...
<dd><time><span class="news_time">〔更新日　<?=$date?>〕</span></time></dd>
